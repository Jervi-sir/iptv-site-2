  ...
  return (
    <section className="relative pt-28 pb-20 md:pt-36 md:pb-24 px-6 overflow-hidden max-w-7xl mx-auto">
      {/* <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        <div className="absolute top-0 right-0 bg-zinc-200/10 w-96 h-96 rounded-full blur-3xl"></div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className={`space-y-4 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
            ...
            <div className="flex flex-wrap gap-4 pt-0">
              ...
              <Link href="/#pricing">
                <Button variant="outline" className="text-lg cursor-pointer hover:bg-zinc-200 hover:text-zinc-800 hover:scale-105">Explore Plans</Button>
              </Link>
            </div>
            <div className="flex flex-wrap gap-6 pt-4 text-sm">
              ...
              <div className="flex items-center gap-2">
                <Book size={20} className="text-zinc-500" />
